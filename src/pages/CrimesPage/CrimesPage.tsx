...
export const CrimesPage:FC = () => {
  const { forces, loading: forcesLoading, error: forcesError } = usePoliceContext()
  const { crimes, loading, error, infoMessage, fetchCrimes } = useCrimesContext()
  ...
  const paginatedCrimes = crimes.slice((page - 1) * crimesPerPage, page * crimesPerPage)
